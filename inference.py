...
# ======  config  ======
INPUT_PATH = "./results/instruction-ultrafeedback50.jsonl"            # "instruction" jsonl
OUTPUT_PATH = "./results/inference-ultrafeedback50-1.jsonl"             # instruction + 4 responses jsonl
