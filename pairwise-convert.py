...
def convert_data(input_file_name, train):
    file_path = f"/data/seohyeong/instruction-refinement/data/10-1-min/{input_file_name}-pairwise.jsonl"
    cnt = 0
...
def main(cfg: DictConfig):
    ...
    input_path = "/data/seohyeong/instruction-refinement/results/feedback-api-6000-re/yeval/min_original_left.jsonl"
